@ECHO OFF                                                                                                     
									SET "PHP_PEAR_SYSCONF_DIR=D:\Bitnami\redmine-3.3.2-2\php"
...
FOR %%x IN ("D:\Bitnami\redmine-3.3.2-2\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\Bitnami\redmine-3.3.2-2\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\Bitnami\redmine-3.3.2-2\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\Bitnami\redmine-3.3.2-2\php\php.exe"
